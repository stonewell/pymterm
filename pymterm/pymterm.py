...
def args_parser():
    ...
    parser.add_argument('--color_theme', choices=['tango', 'solarized_dark', 'solarized_light', 'terminal', 'zenburn'], help='the terminal color theme, default is tango', default='tango', required = False)
